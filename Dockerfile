# This tells Docker whihc image to use, this is an official ruby image from docker
FROM ruby:2.6

# Update the repo listins in the container
RUN apt-get update
# Installs the following packages into the container
...
# Specify the enviorment variables APP with the path
ENV APP /usr/src/app
